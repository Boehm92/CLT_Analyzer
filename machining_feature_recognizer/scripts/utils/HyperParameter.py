    ...
    def __init__(self, trial, network_model):
        ...
        if network_model == "GcNetwork":
            ...
            self.params.update({
                ...
                "conv_hidden_channels": trial.suggest_categorical("conv_hidden_channels", [8, 16, 32, 64]),
                "lin_hidden_channels": trial.suggest_categorical("lin_hidden_channels", [64, 128, 256, 512]),
                "attention_heads": trial.suggest_categorical("attention_heads", [6, 8, 10, 12]),
            })
            ...
            self.params.update({
                ...
                "num_layer": trial.suggest_categorical("num_layer", [1, 2, 3, 4]),
            })
            ...
            self.params.update({
                "number_conv_layers": trial.suggest_categorical("conv_layer", [3, 4, 5, 6]),
                "conv_hidden_channels": trial.suggest_categorical("hidden_channels", [32, 64, 128, 256, 512]),
            })
        else:
