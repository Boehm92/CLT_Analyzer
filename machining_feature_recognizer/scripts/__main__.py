...
_parser.add_argument('--project_name',
                     dest='project_name', default='CoCadAi_framework', type=str, #CoCadAi_framework
...
_parser.add_argument('--study_name',
                     dest='study_name', default='MFS_DGCNN', type=str,
...
if __name__ == '__main__':
    ...
    if _config.application_mode == "training":
        _study.optimize(lambda trial: MachiningFeatureRecognizer(_config, trial).training(),
                        n_trials=_config.hyperparameter_trials)
    elif _config.application_mode == "test":
        rest_service_instance = RestService(MachiningFeatureRecognizer(_config, None))
