...
from network_models.GraphConvNetwork import GraphConvNetwork
...
_parser.add_argument(
    ...
    "ArmaNetwork, AgnNetwork, GraphConvNetwork",
)
_parser.add_argument(
    "--network_model_id",
...
if __name__ == "__main__":
    ...
    if _config.application_mode == "training":
        MachiningFeatureRecognizer(_config).training()
    elif _config.application_mode == "test":
        rest_service_instance = RestService(MachiningFeatureRecognizer(_config))
        rest_service_instance.app.run(host="0.0.0.0", port=5002, debug=False)
