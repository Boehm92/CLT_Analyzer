...
class TriangularPocket:
    ...
    def transformation(self):
        ...
        _triangular_pocket = mdc.extrusion(self.dept[self.dir], mdc.flatsurface(_triangular_primitive))
        _manufacturing_time = round(self.manufacturing_time_calculation(_triangular_pocket), 4)

        return _triangular_pocket, _manufacturing_time
