...
class HorizontalCircularEndBlindSlot:
    def __init__(self):
        ...
        self.width = np.random.uniform(1, 2)
        self.length = np.random.uniform(1, 4.5 - (2 * self.width))
        ...
        self.max_volume = 262  # value determined by printing the volume of 3D object with max dimensions
    ...
    def manufacturing_time_calculation(self, _horizontal_circular_end_blind_slot):
        manufacturing_time = (self.max_manufacturing_time
                              * (_horizontal_circular_end_blind_slot.volume() / self.max_volume))
        if self.dir in ["direction_9", "direction_10", "direction_11", "direction_12", "direction_13", "direction_14",
                        "direction_15", "direction_16", "direction_17", "direction_18", "direction_19", "direction_20",
                        "direction_21", "direction_22", "direction_23", "direction_24"]:
            manufacturing_time += self.manufacturing_time_side_supplement
        if self.dir in ["direction_5", "direction_6", "direction_7", "direction_8"]:
    ...
    def transformation(self):
        ...
        _manufacturing_time = round(self.manufacturing_time_calculation(_horizontal_circular_end_blind_slot), 4)

        return _horizontal_circular_end_blind_slot, _manufacturing_time
