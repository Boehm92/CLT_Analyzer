...
class SixSidePocket:
    ...
    def transformation(self):
        _six_side_pocket_primitive = [mdc.Segment(self.six_side_vectors[self.dir]["vector_A"],
        ...
        _six_side_pocket = mdc.extrusion(self.depth[self.dir], mdc.flatsurface(_six_side_pocket_primitive))
        _manufacturing_time = round(self.manufacturing_time_calculation(_six_side_pocket), 4)

        return _six_side_pocket, _manufacturing_time
