...
class PowerOutlet:
    def __init__(self, _base_primitive):
        self.dir = "direction_1" # np.random.choice(["direction_1", "direction_2"])

        self.radius = 34
        self.pos_x = np.random.uniform(self.radius + 100, _base_primitive.length - self.radius - 100)
        self.pos_z = np.random.uniform(self.radius + 100, _base_primitive.height - self.radius - 100)
        ...
        self.max_manufacturing_time = 0.2
