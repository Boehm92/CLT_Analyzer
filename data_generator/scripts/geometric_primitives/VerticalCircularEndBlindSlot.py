...
class VerticalCircularEndBlindSlot:
    def __init__(self):
        ...
        self.edge_position = np.random.uniform(4, 6)
        self.width = np.random.uniform(3.5, (7 - self.edge_position))
        self.length = np.random.uniform(3.5, (8 - self.width))
        self.depth = np.random.uniform(1, 9)
        self.negative_start_point = -0.0001
        self.positive_start_point = 10.0001

        self.max_volume = 331  # value determined by printing the volume of 3D object with max dimensions
        self.max_manufacturing_time = 1.30
    ...
    def manufacturing_time_calculation(self, _vertical_circular_end_blind_slot):
        manufacturing_time = (self.max_manufacturing_time
                              * (_vertical_circular_end_blind_slot.volume() / self.max_volume))
        if self.dir in ["direction_1", "direction_2", "direction_3", "direction_4", "direction_5", "direction_6",
                        "direction_7", "direction_8", "direction_17", "direction_18", "direction_19", "direction_20",
                        "direction_21", "direction_22", "direction_23", "direction_24"]:
            manufacturing_time += self.manufacturing_time_side_supplement
        if self.dir in ["direction_13", "direction_14", "direction_15", "direction_16"]:
    ...
    def transformation(self):
        ...
        _manufacturing_time = round(self.manufacturing_time_calculation( _vertical_circular_end_blind_slot), 4)

        return _vertical_circular_end_blind_slot, _manufacturing_time
