...
class CircularBlindStep:
    ...
    def manufacturing_time_calculation(self, _circular_blind_step):
        manufacturing_time = self.max_manufacturing_time * (_circular_blind_step.volume() / self.max_volume)

        if self.dir in ["direction_2", "direction_3", "direction_5", "direction_6", "direction_8", "direction_9",
                        "direction_11", "direction_12", "direction_14", "direction_15", "direction_17", "direction_18",
                        "direction_20", "direction_21", "direction_23", "direction_24"]:
    ...
    def transformation(self):
        _circular_blind_step = mdc.cylinder(self.circular_vectors[self.dir][0], self.circular_vectors[self.dir][1],
                                            self.radius)
        _manufacturing_time = round(self.manufacturing_time_calculation(_circular_blind_step), 4)

        return _circular_blind_step, _manufacturing_time
