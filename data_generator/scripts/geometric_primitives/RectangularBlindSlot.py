...
class RectangularBlindSlot:
    def __init__(self):
        ...
        self.depth = np.random.uniform(self.pos_z + 0.5, 9.5)
    ...
    def manufacturing_time_calculation(self, rectangular_passage):
        ...
        if self.dir in ["direction_3", "direction_4", "direction_7", "direction_8"]:
            manufacturing_time += self.manufacturing_time_side_supplement
        if self.dir in ["direction_1", "direction_5", "direction_9", "direction_11"]:
